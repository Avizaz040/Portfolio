...
const cards = [
  {
    description: "Bacheor's Degree in Arts",
    title: "Sammilani Mahavidyalaya",
    src: College,
    ctaText: "Show Details",
    ctaLink: "https://www.sammilanimahavidyalaya.ac.in/",
    content: () => {
      return (
        (<p> Sammilani Mahavidyalaya | 2008–2011 <br /> <br /> Graduated with Honors in Philosophy
                  </p>)
      );
    },
  },
  {
    description: "Higher Secondary (Arts)",
    title: "Rajpur Vidyanidhi High School",
    src: School,
    ctaText: "Show Details",
    ctaLink: "https://g.co/kgs/CJAKZWr",
    content: () => {
      return (
        (<p> Rajpur Vidyanidhi High School | 2006–2008 <br /> <br /> Higher Secondary in Arts.
                  </p>)
      );
    },
  },

  {
    ...
    content: () => {
      return (
        (<p> Rajpur Vidyanidhi High School | 2006 <br /> <br /> Passed 10th standard with 2nd division.
                  </p>)
      );
    },
  },
