...
function AuroraBackgroundDisplay() {
  ...
  return (
    <AuroraBackground>
      ...
      >
        <div className=" text-3xl md:text-8xl font-bold text-white dark:text-white text-center py-4">
          Hello.
        </div>
        <div className="font-normal text-base md:text-6xl text-white dark:text-neutral-200 py-4">
          I am
        </div>
        <div className="font-semibold text-base md:text-9xl text-white dark:text-neutral-200 py-2">
